	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if(selection != null && selection instanceof ITreeSelection) {
			...
			if(nodejsPath == null || nodejsPath.isEmpty()) {
				MessageDialog.openWarning(window.getShell(), "High Web Warning - NodeJS Path",
			...
			try {
				...
				try {
					...
					MessageDialog.openWarning(window.getShell(), "High Web Warning - Mozilla Firefox Installation",
			...
			if(firefoxPath == null || firefoxPath.isEmpty()) {
				MessageDialog.openWarning(window.getShell(), "High Web Warning - Firefox Path",
			...
			try {
				...
				String helper = progFilesx86Dir + File.separator + "Mozilla Firefox"
						+ File.separator + "uninstall" + File.separator
						+ "helper.exe";
